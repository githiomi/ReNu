...
public class YelpService {
    ...
    public static void findRestaurants(String location, Callback callback) {
        ...
        HttpUrl.Builder urlBuilder = HttpUrl.parse(ApiConstants.YELP_BASE_URL).newBuilder();
        urlBuilder.addQueryParameter(ApiConstants.YELP_LOCATION_QUERY_PARAMETER, location);
        String url = urlBuilder.build().toString();

        Request request = new Request.Builder()
                .url(url)
                .header("Authorization", ApiConstants.YELP_TOKEN)
                .build();
